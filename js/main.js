(function ($) {
    ...
    $(document).on("ready", function () {
        ...
        $(".testimonials.owl-carousel").owlCarousel({ nav: true, items: 3, loop: false, navText: false, margin: 10, responsive: { 0: { items: 1 }, 480: { items: 1 }, 768: { items: 2 }, 1200: { items: 3 } } });
        $(".text-rotation").owlCarousel({ loop: true, dots: false, nav: false, margin: 10, items: 1, autoplay: true, autoplayHoverPause: false, autoplayTimeout: 3800, animateOut: "zoomOut", animateIn: "zoomIn" });
